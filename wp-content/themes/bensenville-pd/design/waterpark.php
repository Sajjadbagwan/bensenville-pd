				...
				<div class="new-content">
					...
					<div class="conter-inner-div clearfix">
						<div class="content-left">
							...
							<ul class="waterpark-ul">
								...
								<li>
								<li>Free admission to Glow Swim</li>
								<li>Each season pass holder may bring one friend for free!</li>
							</ul>
					...
					<div class="waterpark-slider">
						<div class="owl-carousel owl-theme">
							<div class="item">
								<img src="<?php echo get_template_directory_uri(); ?>/images/waterpark.jpg" alt="">
							</div>
							<div class="item">
								<img src="<?php echo get_template_directory_uri(); ?>/images/waterpark.jpg" alt="">
							</div>
